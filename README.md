...
(for example, http://people.csail.mit.edu/rivest/Sexp.txt), but presents a
...
The above example will naturally serialize from / deserialize into the following classes:
